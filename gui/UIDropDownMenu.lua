...
-- luacheck: globals max VIDEO_QUALITY_LABEL6 RGPVPW_uiDropdownMenu_InitializeHelper PlaySound CloseMenus
...
function RGPVPW_uiDropdownMenu_InitializeHelper(frame)
...
function me.uiDropdownMenu_Initialize(frame, initFunction, displayMode, level, menuList)
  ...
  securecall("RGPVPW_uiDropdownMenu_InitializeHelper", frame)
